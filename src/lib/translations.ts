...
Si es sobre reglas del edificio, envíalo a todos.`,
    ...
    features: {
      ...
      list: {
        ...
        meetings: {
          ...
          description: 'Organiza reuniones de junta y mantén actas digitales',
        },
        realtime: {
    ...
    about: {
      ...
      founder: {
        ...
        storyTitle: 'Proyecto Personal con Propósito',
        story: 'Ingeniero de Microsoft. Egresado UPR Mayagüez. Fuera del trabajo, construyo soluciones para los problemas reales que veo en condominios de PR.',
        locationTitle: 'Diseñado para Puerto Rico',
        location: 'Blok no es una solución importada—está diseñada específicamente para cómo nos comunicamos en Puerto Rico.',
        mission: 'Mi misión: demostrar que desde Puerto Rico podemos construir tecnología de clase mundial.',
      },
      company: {
        founded: 'Fundado',
        based: 'San Juan, PR',
...
If it's about building rules, send it to everyone.`,
    ...
    features: {
      ...
      list: {
        ...
        oneOnOne: {
          ...
          description: 'Each resident has their own private chat',
        },
        meetings: {
          title: 'Meeting Management',
          description: 'Organize board meetings and keep digital minutes',
        },
        realtime: {
    ...
    about: {
      ...
      founder: {
        ...
        storyTitle: 'Personal Project with Purpose',
        story: 'Microsoft engineer. UPR Mayagüez graduate. Outside of work, I build solutions for the real problems I see in PR condos.',
        locationTitle: 'Built for Puerto Rico',
        location: 'Blok isn\'t an imported solution—it\'s designed specifically for how we communicate in Puerto Rico.',
        mission: 'My mission: prove that from Puerto Rico we can build world-class technology.',
      },
      company: {
        founded: 'Founded',
        based: 'San Juan, PR',
