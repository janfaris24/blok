export const translations = {
  es: {
    ...
    maintenance: {
      ...
      total: 'Total',
      urgent: 'Urgente',
      searchPlaceholder: 'Buscar por descripción, categoría, o residente...',
    ...
    features: {
      ...
      list: {
        ...
        smartRouting: {
          ...
          description: 'Mensajes dirigidos automáticamente a la persona correcta',
        },
        autoTickets: {
        ...
        broadcasts: {
          ...
          description: 'Envía mensajes a todos con un clic',
        },
        oneOnOne: {
    ...
    ai: {
      ...
      capabilities: {
        intent: {
          ...
          description: 'Identifica automáticamente si es una pregunta, emergencia o solicitud de mantenimiento',
        },
        priority: {
          title: 'Priorización Inteligente',
          description: 'Clasifica urgencia: baja, media, alta o emergencia según el contexto',
        },
        knowledge: {
          title: 'Base de Conocimiento',
